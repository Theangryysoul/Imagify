...
const Header = () => {
  return (
    <div className='flex flex-col jsutify-center items-center text-center my-20'>
        ...
        <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer'>Generate Images
